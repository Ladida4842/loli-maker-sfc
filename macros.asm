...
elseif <addr>>>16 < $80
	if <addr>>>16 >= $70 && <addr>&$008000 != $008000
		print "file will assemble; will not be accessible during runtime"
	elseif <addr>>>16 >= $7E && <addr>&$008000 == $008000
		print "file will assemble; should be accessed through banks $3E-3F or $BE-BF"
	endif
	incbin <file> -> <addr>&$3FFFFF|$400000
else
...
STA $4310		; 1 reg write (read) once, $2180
LDA <srcaddr>		;
STA $4312		; set the lower two bytes of the destination address
LDY <srcbank>		;
STY $4314		;
LDA <datasize>		; number of bytes to transfer
STA $4315		;
LDY #$02		; DMA channel 1
STY $420B		;
PLP			;
endmacro
